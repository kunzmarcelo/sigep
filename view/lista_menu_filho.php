                                ...
                                <form method="post" role="form">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="icone" id="icone" class="form-control" style="font-family: FontAwesome, sans-serif;" required="required">
                                            ...
                                            <option  aria-hidden='true' value="fa fa-list" >&#xf03a; </option>
                                            <option  aria-hidden='true' value="fa fa-edit">&#xf044;	</option>
                                            <option  aria-hidden='true' value="fa fa-line-chart">&#xf201; </option>
                                            <option  aria-hidden='true' value="fa fa-table">&#xf0ce; </option>
                                            <option  aria-hidden='true' value="fa fa-cogs">&#xf085; </option>
                                            <option  aria-hidden='true' value="fa fa-object-group">&#xf247; </option>
