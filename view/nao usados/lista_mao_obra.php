...
<html lang="pt-BR">
    ...
    <body>
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Lista de despesas fixas</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            ...
            <div class="row">
                <div class="col-lg-12">                    
                    <div class="panel-heading">
                        ...
                        <a href="cadastra_mao_obra.php" class="btn btn-info"><span class='glyphicon glyphicon-plus'></span> Adicionar</a>
                    </div>
