        ...
        <div class="container">
            <div class="col-lg-12">
                ...
                <div class="panel-heading">
                    ...
                    <a href="lista_mao_obra.php" class="btn btn-default"><span class="glyphicon glyphicon glyphicon-th-list"></span> Listar</a>
                            ...
                            <form method="post" class="form-horizontal">
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="valor" name="valor" class="form-control" placeholder="Ex: 0.15"/>
                                    </div>                                       
                                    <!--
...
//                            $tempo_producao = \filter_input(INPUT_POST, 'tempo_producao');
                        ...
                        if (isset($cadastro)) {
                            if (empty($descricao) || empty($valor)) {
                                ...
                                $status = $fun->cadastraFuncao($descricao, $valor);
                                if ($status == true) {
