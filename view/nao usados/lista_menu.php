...
<?php require_once './actionfonteMenu.php'; ?>
            <div id="page-wrapper">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Cadastro de Menus</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <form method="post" role="form">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="ordem_pai" name="ordem_pai" class="form-control" required="required" placeholder="descrição do lote"/>
                                            </div>
                                            <div class="form-group">
...
//instancia a classe de controle
                                ...
                                if (isset($cadastro)) {
                                    if (empty($nome_pai)) {
                                        ...
                                        $status1 = $prod->cadastraMenuPai($nome_pai, $status_pai, $ordem_pai);
                                        if ($status1 == true) {
                                        ...
                                        <tbody>                       
                                            ...
                                            while ($dados = $matriz->fetchObject()) {
                                                ...
                                                if ($dados->status_pai == FALSE) {
                                                    ...
                                                    echo "<tr>
                                                   <td title='id_menu'>" . $dados->id_menu . "</td>                                                   
                                                    <td title='nome' class='editavel'>" . $dados->nome_pai . "</td>  
                                                    <td>     
