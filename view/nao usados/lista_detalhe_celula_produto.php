    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Produção Cadastrada</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row -->
                    ...
                    <div class="col-lg-12">
                        <form class="form-horizontal" method="post">
                            ...
                            <div class="form-group">                                
                                <div class="col-xs-6 col-sm-4">
                                    ...
                                    <input type="date" name="data" onchange="this.form.submit()" class="form-control" required="required" >
                                </div>
                            </div>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading" style="text-align: center">
                                Lista de produção cadastrada por data
                            </div>
                            <table width="100%" class="table table-striped table-bordered table-hover" id="tblEditavel">
                                ...
                                <tbody>                       
                                    ...
                                    if (empty($data_ini)) {
                                        ...
                                        $matriz = $lote->listaCelulaProdutoTodos($data_ini);
                                        $diferenca = 0;
                                        $somaTempoHora = 0;
                                        $somaTempoMinu = 0;
                                        $somaTempoSegu = 0;
                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            ...
                                            <td><?= number_format($diferenca = ((($somaPecaPronta * 100)) / $somaPeca), 2, '.', '.'); //porcentagem                                                                                                 ?> %</td>
                                            <td> 
                                                <?php
                                ...
                                <!--                            <div class="form-group">
                                                                <div class="col-xs-12 col-sm-12">
                                                                    ...
                                                                    <label for="legenda">¹ Reajuste: tempo estimado de produção em sofre um reajuste de <?= $porcentagem ?>% de aumento a partir da data 08/11/2017 .</label><br>
