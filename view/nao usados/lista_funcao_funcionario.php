        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">                    
                    ...
                    <h1 class="page-header"><span class="glyphicon glyphicon-filter" aria-hidden="true"></span>Filtro de produção e rentabilidade de funcionários.</h1>
                                        ...
                                        <table class="table table-hover" id="tblEditavel">
                                            ...
                                            <tbody>
                                                ...
                                                while ($dados = $matriz->fetchObject()) {
                                                    ...
                                                    $entrada = $dados->hora_ini;
                                                    $saida = $dados->hora_fim;
                                                    $intervalo = '02:00:00';
