...
<html>
    ...
    <body>
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Gráfico de faturamento mensal</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            ...
            <div class="row">
                <div class="panel-heading">
                    ...
                    <a href="grafico_fabrica_producao.php" class="btn btn-info"><span class="glyphicon glyphicon-briefcase"></span> Produção</a>
                </div>
            </div>
        ...
        <script type="text/javascript">
            ...
            function drawChart() {
                var data = google.visualization.arrayToDataTable([
                    ['Mês', 'Faturamento R$', 'Meta de faturamento R$', 'Média diária R$'],
<?php
    ...
    while ($dados = $matriz->fetchObject()) {
        if (!empty($dados->VALOR)) {
            ...
            if ($mes_ini == '12')
                $mes = 'Dezembro';
            $meta = $meta_fatu;
            $SOMAVALOR = $dados->VALOR;
            $media = $SOMAVALOR / 20;
            $resultado = "['$mes/$ano_ini',$SOMAVALOR,$meta,Math.round($media)],";
            echo $resultado;
        }
    }
    $mes_ini++;
