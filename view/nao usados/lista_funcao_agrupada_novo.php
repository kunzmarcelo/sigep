        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">                    
                    ...
                    <h1 class="page-header"><span class="glyphicon glyphicon-filter" aria-hidden="true"></span>NOVA VERSÃO -> Lista de funções agrupadas.</h1>
                                            ...
                                            <tbody>
                                                ...
                                                while ($dados = $matriz->fetchObject()) {
                                                    ...
                                                    echo "<tr>                                                       
                                                            ...
                                                            <td title='Total de peças'><b>R$ " . number_format($dados->TOTAL, 2, ',', '') . "</b></td>                                                                
