                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        if (empty($data_ini)) {
                                            ...
                                            <?php
                                            include_once './scripts_graficos_4.php';
                                        }
                                        ?>
                                    </div>
                                </div>                                
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        if (empty($data_ini)) {
                                            ...
                                            <div class="panel panel-default">
                                                ...
                                                <div id="pecas_produzidas_celulas6" style="width: 100%; height: 100%"></div>
                                            </div>
                                            <?php
                                            include_once './scripts_graficos_6.php';
                                        }
                                        ?>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        if (empty($data_ini)) {
                                            ...
                                            <div class="panel panel-default">
                                                ...
                                                <div id="pecas_produzidas_celulas8" style="width: 100%; height: 100%"></div>
                                            </div>
                                            <?php
                                            include_once './scripts_graficos_8.php';
                                        }
                                        ?>
                                    </div>
                                </div>
